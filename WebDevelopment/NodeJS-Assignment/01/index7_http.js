...
const server = http.createServer((req,res)=>{
    if(req.url === '/'){
        ...
        res.write('<h2>I Am Happy To Learn Full Stack Web Development From PW Skills!</h2>');
    }
    res.end();
})

server.listen(5004);
console.log(`The HTTP server is running on port 5004.`);
